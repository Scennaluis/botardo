...
global.reloadHandler = function () {
  ...
  conn.welcome = 'que onda gato, bienvenido y si sufris bullying no llores'
  conn.bye = 'alta putita aburrida sos, nv.'
  conn.spromote = '@user sos admin aprovecha'
  conn.sdemote = '@user ni ahi con giles te saco el admin'
